        ...
        <div className="md:sticky relative md:top-10 md:w-[500px] w-full">
            <div className="w-full bg-white rounded-lg p-5 border border-gray-200">
                <div className="w-full flex items-center justify-between">
                    ...
                    <CloseCircleOutline cssClasses={"cursor-pointer"} color="#ed5a85" onClick={handleCloseFilter} />
                </div>
                            ...
                            if (j) {
                                return (
                                    <div key={job} className="text-gray-800 flex items-center justify-between w-full border-b border-gray-300 pb-3">
                                        ...
                                        <button onClick={() => navigate(`/jobs/${j.id}`)} className="text-white font-semibold text-[15px] rounded-md bg-indigo-500 w-20 h-8">Apply</button>
                                    </div>
                                );
                            }
                            return null;
